...
class TestRectangle:
    def test_rectangle_get_area_positive(self):
        ...
        assert r.get_area() == value_a * value_b, f"value_a generated = {value_a} and value_b generated = {value_b}"

    def test_rectangle_get_perimeter_positive(self):
        value_a = GenerateNumberGreaterThanZero()
        value_b = GenerateNumberGreaterThanZero()
        r = Rectangle(value_a, value_b)
        assert r.get_perimeter() == 2 * (value_a + value_b), f"value_a generated = {value_a} and value_b generated = {value_b}"
